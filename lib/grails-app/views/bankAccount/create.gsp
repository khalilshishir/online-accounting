...
<%@ page import="org.dao.oa.BankAccount" contentType="text/html;charset=UTF-8" %>
            ...
            <fieldset style="padding: 0 0 0 35px;margin-left: 0px;margin-right: 0px">
                <div class="form-group required">
                    ...
                    <div class="col-md-3 required">
                        <g:select class="form-control" required="required" id="project" name='project' value="${bankAccount?.project?.id}"
                                  noSelection="${["": 'Please Select...']}"
                                  from='${Project.findAllWhere(isActive: true)}'
                ...
                <div class="form-group required">
                    ...
                    <div class="col-md-3 required">
                        <g:textField name="bankName" id="bankName" required="required" class="form-control" value="${bankAccount?.bankName}"/>
                    </div>
                </div><br/><br/>
                ...
                <div class="form-group required">
                    ...
                    <div class="col-md-3 required">
                        <g:textField name="bankAccountName" id="bankAccountName" required="required" class="form-control" value="${bankAccount?.bankAccountName}"/>
                    </div>
                </div><br/><br/>
                ...
                <div class="form-group required">
                    ...
                    <div class="col-md-3 required">
                        <g:select class="form-control" required="required" id="coaMaster" name='coaMaster' value="${bankAccount?.coaMaster?.id}"
                                  noSelection="${["": 'Please Select...']}"
                                  from='${CoAMaster.findAllWhere(isActive: true)}'
                ...
                <div class="form-group required">
                    ...
                    <div class="col-md-3 required">
                        <g:textField name="accountNumber" id="accountNumber" required="required" class="form-control" value="${bankAccount?.accountNumber}"/>
                    </div>
                </div><br/><br/>
                ...
                <div class="form-group required">
                    ...
                    <div class="col-md-3 required">
                        <g:select class="form-control" required="required" id="accountType" name='accountType'
                                  noSelection="${["": 'Please Select...']}"
                                  from="${AccountType.values()}" keys="${AccountType.values()*.name()}"
                                  optionKey="key" optionValue="" tabindex="4" value="${bankAccount?.accountType}"></g:select>
                ...
                <div class="form-group required">
                    ...
                    <div class="col-md-3 required">
                        <g:textField name="address" id="address" required="required" class="form-control" value="${bankAccount?.address}"/>
                    </div>
                </div><br/><br/>
