...
<div class="container">
    <div class="row">
        ...
        <form action='${resource(dir:'department', file:'save')}'>
           <g:hiddenField name="hidDepartmentId" value="${hidDepartmentId}"/>
            <h3>Create Department</h3>

            <fieldset style="padding: 0 0 0 35px;margin-left: 0px;margin-right: 0px">
                <div class="form-group required">
                    <label class="col-md-2 control-label" for="deptName" >Name</label>
                    <div class="col-md-3 required">
                        <g:textField name="deptName" class="form-control" value="${deptName}"/>
                    </div>
                </div><br>

                <div class="form-group required">
                    <label class="col-md-2 control-label" for="deptLoc">Location</label>
                    <div class="col-md-3 required">
                        <g:textField name="deptLoc" class="form-control" value="${deptLoc}"/>
                    </div>
                </div><br>
            ...
            <table id="example" style="width: 750px;" class="dataListTable table table-bordered table-striped table-hover table-condensed">
                ...
                <g:each in="${departmentList}" var="department">
                    ...
                    <tr>
                        ...
                        <td>${department?.deptLoc}</td>
                        <td class="actions ">
                            <div class="btn-group">
                                <a class="btn btn-warning"
                                   href="${g.createLink(controller: 'department', action: 'update', params: [id: department?.id])}"
                                   title="Edit"><i class="fa fa-eye" ></i></a>
                                <a class="btn btn-danger delete" onclick="return confirm('Are you sure delete student?')"
                                   href="${g.createLink(controller: 'department', action: 'delete', params: [id: department?.id])}"
